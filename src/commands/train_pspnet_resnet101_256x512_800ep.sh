...
uv run python src/baseline_train_mmseg.py \
  ...
  --backbone resnet101 \
  --pretrained \
  --result_dir /home/igarashi_25/playground_2/discrimination/result/pspnet_resnet101_aug_256x512_800ep \
  --num_classes 20 \
  --eval_num_classes 19 \
  --image_size 256 512 \
  ...
  --amp_dtype bf16 \
  --wandb \
  --wandb_project cityscapes20-pspnet \
  --wandb_run_name pspnet_resnet101_aug_256x512_800ep
