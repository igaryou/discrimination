...
uv run python src/baseline_train_mmseg.py \
  ...
  --backbone swin_small \
  --pretrained \
  --result_dir /home/igarashi_25/playground_2/discrimination/result/upernet_swin_small_aug_256x512_800ep \
  --num_classes 20 \
  --eval_num_classes 19 \
  --image_size 256 512 \
  ...
  --amp_dtype bf16 \
  --wandb \
  --wandb_project cityscapes20-upernet \
  --wandb_run_name upernet_swin_small_aug_256x512_800ep
